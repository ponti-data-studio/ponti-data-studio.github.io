# SI-NOMOR — PWA Wrapper

Folder ini membungkus Web App SI-NOMOR (Google Apps Script) sebagai aplikasi
...
3. Buka URL hosting tersebut di Chrome (Android/desktop) atau Safari (iOS):
   - **Android/Chrome/Edge**: popup "Pasang SI-NOMOR?" akan muncul otomatis
